...
This paper,[Enriching Word Vectors with Subword Information (Bojanowski et al., arXiv 2017)](https://arxiv.org/abs/1607.04606v2) have been arguing it is better on inference of words out of Vocabulary by using character levels n-gram. 
...
<div class="alert alert-success" role="alert"><i class="fa fa-paperclip fa-lg"></i> <b>Download URL: </b><br>
  <a href="https://arxiv.org/abs/1607.04606v2">The paper: Enriching Word Vectors with Subword Information (Bojanowski et al., arXiv 2017)</a>
</div>

# Reference 

- Paper 
  - [arXiv Version: Enriching Word Vectors with Subword Information (Bojanowski et al., arXiv 2017)](https://arxiv.org/abs/1607.04606v2)
