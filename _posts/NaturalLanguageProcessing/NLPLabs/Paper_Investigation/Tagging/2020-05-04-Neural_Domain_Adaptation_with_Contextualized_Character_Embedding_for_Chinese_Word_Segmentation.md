...
For example, we have a sequence of characters in window size of 5 like \(w_1\) =  \([x_i-2, x_i-1, x_i, x_i+1, x_i+2]\) which is concatenation of 5 character embedding around 
\(x_i\)
