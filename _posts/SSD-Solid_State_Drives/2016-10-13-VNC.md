...
● vncserver@:1.service - Remote desktop service (VNC)
  ...
  Process: 9825 ExecStart=/usr/sbin/runuser -l hyunyoung.lee -c /usr/bin/vncserver %i (code=exited, status=0/SUCCESS)
  Process: 9816 ExecStartPre=/bin/sh -c /usr/bin/vncserver -kill %i > /dev/null 2>&1 || : (code=exited, status=0/SUCCESS)
 Main PID: 9863 (Xvnc)
   CGroup: /system.slice/system-vncserver.slice/vncserver@:1.service
           ‣ 9863 /usr/bin/Xvnc :1 -desktop exmple.com:1 (hyunyoung.lee) -auth /home/hyunyo...

Oct 17 14:41:52 example.~~~.com systemd[1]: Starting Remote desktop service (VNC)...
Oct 17 14:41:56 example.com systemd[1]: Started Remote desktop service (VNC).
```
...
● vncserver@:1.service - Remote desktop service (VNC)
  ...
  Process: 8593 ExecStart=/usr/sbin/runuser -l hyunyoung.lee -c /usr/bin/vncserver %i (code=exited, status=98)
  Process: 8584 ExecStartPre=/bin/sh -c /usr/bin/vncserver -kill %i > /dev/null 2>&1 || : (code=exited, status=0/SUCCESS)

Oct 17 11:35:56 example.com systemd[1]: Starting Remote desktop service (VNC)...
Oct 17 11:35:56 example.com systemd[1]: vncserver@:1.service: control process exited, code=exited status=98
Oct 17 11:35:56 example.com systemd[1]: Failed to start Remote desktop service (VNC).
Oct 17 11:35:56 example.com systemd[1]: Unit vncserver@:1.service entered failed state.
Oct 17 11:35:56 example.com systemd[1]: vncserver@:1.service failed.
```
...
● vncserver@:1.service - Remote desktop service (VNC)
  ...
  Process: 9418 ExecStart=/usr/sbin/runuser -l hyunyoung.lee -c /usr/bin/vncserver %i (code=exited, status=1/FAILURE)
  Process: 9410 ExecStartPre=/bin/sh -c /usr/bin/vncserver -kill %i > /dev/null 2>&1 || : (code=exited, status=0/SUCCESS)

Oct 17 14:38:10 example.com systemd[1]: Starting Remote desktop service (VNC)...
Oct 17 14:38:11 example.com systemd[1]: vncserver@:1.service: control process exited, cod...s=1
Oct 17 14:38:11 example.com systemd[1]: Failed to start Remote desktop service (VNC).
Oct 17 14:38:11 example.com systemd[1]: Unit vncserver@:1.service entered failed state.
Oct 17 14:38:11 example.com systemd[1]: vncserver@:1.service failed.
...
● vncserver@:1.service - Remote desktop service (VNC)
 ...
 Main PID: 9863 (Xvnc)
   CGroup: /system.slice/system-vncserver.slice/vncserver@:1.service
           ‣ 9863 /usr/bin/Xvnc :1 -desktop example.com:1 (hyunyoung.lee) -auth /home/hyunyo...
