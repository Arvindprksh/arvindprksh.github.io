...
<div class="posts-list" style="margin-bottom: 70px; margin-top: 70px;">
  <div class="blog-tags" style="margin-bottom: 70px; margin-top: 70px;"> 
  ...
  <div class="post-preview" style="margin-bottom: 70px; margin-top: 70px;"> <!--post-preview -->
    {% for tag in tags %}
      <h2 id="{{ tag[0] | slugify }}"> {{ tag[0] }}  <i class="badge">{{ tag | last | size }}</i></h2> <!-- I added new class -->
      <ul class="later on" style="margin-bottom: 70px; margin-top: 70px;"> <!-- post-subtitle -->
        {% for post in tag[1] %}
